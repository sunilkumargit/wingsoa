...
namespace Wing
{
    ...
    public static class MathHelper
    {
        ...
        {
            return Convert.ToInt32(Math.Floor(Convert.ToDecimal(value / 10)) * 10);
        }

        public static Int32 GetDecimalIntegerFloor(Decimal value)
        {
            return GetDecimalIntegerFloor(Convert.ToInt32(Math.Floor(value)));
        }
