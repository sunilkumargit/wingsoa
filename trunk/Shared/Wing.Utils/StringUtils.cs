...
namespace Wing.Utils
{
    ...
    public static class StringUtilsExtensions
    {
        ...
        {
            return StringUtils.Copy(str, startIndex, count);
        }

        public static String Copy(this String str, int count)
        {
            return StringUtils.Copy(str, 0, count);
        }

        public static String FirstWord(this String str)
        {
            return StringUtils.FirstWord(str);
        }
