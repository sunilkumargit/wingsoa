...
namespace Wing.Json.Collections
{
    #region Imports
...
#if SILVERLIGHT
    public abstract class KeyedCollection : System.Collections.ObjectModel.KeyedCollection<object, object>
    {
        protected abstract object KeyFromValue(object value);

        protected override object GetKeyForItem(object item)
        {
            return this.KeyFromValue(item);
        }

        protected internal object GetByKey(object key)
        {
