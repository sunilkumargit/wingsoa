...
namespace Wing.Client.Sdk.Controls
{
    ...
    public class ModalDialog
    {
        ...
        public ModalDialog()
        {
            ...
            OkButton = new SimpleButton() { Width = 75, HorizontalAlignment = HorizontalAlignment.Right, Margin = new Thickness(0) };
            OkButton.Content = "Ok";
            OkButton.Click += new RoutedEventHandler(OkButton_Click);
            buttonsPanel.Children.Add(OkButton);

            CancelButton = new SimpleButton() { Width = 75, HorizontalAlignment = HorizontalAlignment.Right, Margin = new Thickness(10, 0, 0, 0) };
