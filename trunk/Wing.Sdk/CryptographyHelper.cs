...
namespace Wing
{
    ...
    {
        private static RC2CryptoServiceProvider cryptoProvider = new RC2CryptoServiceProvider();
        private static byte[] RCS_IV_BYTES = { 28, 130, 112, 64, 48, 92, 16, 8, 72, 126, 16, 22, 58, 96, 114, 32 };
        private static String cryptoKey = "mDznDsLc";
        ...
        public static string Decode(byte[] bytes, String key)
        {
            ...
            return ascii.GetString(result, 0, result.Length);
        }
