namespace Telerik.IO.Packaging
{
    ...
    internal sealed class Crc32
    {
        ...
        {
            return (CrcTable[(int)((IntPtr)((oldCrc ^ value) & 0xff))] ^ (oldCrc >> 8));
        }
        ...
        public void Update(int value)
        {
            ...
            this.crc = CrcTable[(int)((IntPtr)(((ulong)(this.crc ^ value)) & ((ulong)0xffL)))] ^ (this.crc >> 8);
            this.crc ^= uint.MaxValue;
        }
        ...
        public void Update(byte[] buffer, int offset, int count)
        {
            ...
            while (--count >= 0)
            {
                this.crc = CrcTable[(int)((IntPtr)((this.crc ^ buffer[offset++]) & 0xff))] ^ (this.crc >> 8);
            }
            this.crc ^= uint.MaxValue;
        }
