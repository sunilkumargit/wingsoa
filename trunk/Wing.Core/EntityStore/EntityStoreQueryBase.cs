...
namespace Wing.EntityStore
{
    public abstract class AbstractEntityStoreQuery : IEntityStoreQuery
    {
        ...
        public virtual IEntityStoreQuery AddFilter(IEntityStoreFilter filter)
        {
            Filters.Add(filter);
            return this;
        }

        public virtual IEntityStoreQuery AddOrder(IEntityStoreOrder order)
        {
            Orders.Add(order);
            return this;
        }
        ...
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.Equals, value));
        }

        public virtual IEntityStoreQuery AddFilterEqualOrGreater(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.EqualOrGreater, value));
        }

        public virtual IEntityStoreQuery AddFilterEqualOrLess(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.EqualOrLess, value));
        }

        public virtual IEntityStoreQuery AddFilterGreaterThan(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.GreaterThan, value));
        }

        public virtual IEntityStoreQuery AddFilterLessThan(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.LessThan, value));
        }

        public virtual IEntityStoreQuery AddFilterNull(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.IsNull, value));
        }

        public virtual IEntityStoreQuery AddFilterNotNull(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.IsNotNull, value));
        }

        public virtual IEntityStoreQuery AddFilterNotEqual(string propertyName, object value)
        {
            return AddFilter(new DefaultStoreFilter(propertyName, ComparisonType.NotEqual, value));
        }

        public virtual IEntityStoreQuery AddOrderAsc(string propertyName)
        {
            return AddOrder(new DefaultStoreOrder(propertyName, false));
        }

        public virtual IEntityStoreQuery AddOrderDesc(string propertyName)
        {
            return AddOrder(new DefaultStoreOrder(propertyName, true));
        }
    }
}
