    ...
    class NHibernateSqlCeEntityStore : IEntityStore
    {
        ...
        private void BuildSectionFactory()
        {
            try
            {
                ...
                _cfg.SetProperty("connection.driver_class", "Wing.Adapters.SqlCe.SqlCeConnectionDriverPatch, Wing.Core");
        ...
        {
            protected NHibernateSqlCeEntityStore _store;

            public NHibernateStoreQuery(Type forType, NHibernateSqlCeEntityStore store)
                : base(forType)
            {
                _store = store;
            }
        ...
        {
            public NHibernateStoreQuery(NHibernateSqlCeEntityStore store)
